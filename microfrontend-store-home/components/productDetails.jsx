        ...
        <div className="space-y-6">
          ...
          <div className="pt-4">
            <div className="flex items-center gap-4">
              ...
              <button onClick={() => addToCart(product)} className="flex-1  bg-orange-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors">Add to Cart</button>
            </div>
          </div>
        </div>
      </div>
